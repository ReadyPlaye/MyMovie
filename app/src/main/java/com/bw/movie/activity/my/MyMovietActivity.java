...
public class MyMovietActivity extends BaseMvpActivity<IContrat.IModel, IContrat.IPresenter> implements IContrat.IView {

//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_my_moviet);
//    }
    ...
    protected int initLayout() {
        return R.layout.activity_my_moviet;
    }
