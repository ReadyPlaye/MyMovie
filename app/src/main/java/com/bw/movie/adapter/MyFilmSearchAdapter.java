...
public class MyFilmSearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context context;
    private final List<BeamRelease.ResultBean> list;

    public MyFilmSearchAdapter(Context context, List<BeamRelease.ResultBean> list) {
        super();
